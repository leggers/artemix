  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved artwork as @artwork" do
        ...
        any_instance_of(Artwork) { |a| mock(a).save {false} }
        post :create, {:artwork => { "locked" => "invalid value" }}, valid_session
        assigns(:artwork).should be_a_new(Artwork)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested artwork" do
        ...
        any_instance_of(Artwork) { |a| mock(a).update({ "locked" => "false" }) }
        put :update, {:id => artwork.to_param, :artwork => { "locked" => "false" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the artwork as @artwork" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        any_instance_of(Artwork) { |a| mock(a).save {false} }
        put :update, {:id => artwork.to_param, :artwork => { "locked" => "invalid value" }}, valid_session
        assigns(:artwork).should eq(artwork)
      end
